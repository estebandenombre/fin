...
-- Asociar transacciones a un banco (nullable)
...
-- Documentos justificantes de gastos deducibles
-- Requiere bucket 'deductible-docs' privado en Storage + políticas de storage (ver migration 20260511000000).
